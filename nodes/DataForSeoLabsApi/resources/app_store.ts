...
export const AppStoreOperations: INodeProperties[] = [
		...
		options: [
			{
				...
				value: 'get-app-store-bulk-app-metrics',
				action: 'Get bulk app metrics',
				description: 'Get ranking metrics for up to 1000 App Store applications',
			},
			{
				name: 'Get Keywords for App',
				value: 'get-app-store-keywords-for-app',
				action: 'Get keywords for app',
				description: 'Get a list of keywords for which the target app ranks on App Store',
			},
			{
				name: 'Get App Competitors',
				value: 'get-app-store-app-competitors',
				action: 'Get app competitors',
				description: 'Get a list of mobile applications that intersect with the target app for its ranking keywords on App Store',
			},
			{
				name: 'Get App Intersection',
				value: 'get-app-store-app-intersection',
				action: 'Get app intersection',
				description: 'Get a list of keywords for which the mobile applications specified in the app_ids object rank within the same App Store SERP',
			}
		],
		default: 'get-app-store-bulk-app-metrics',
	},
	...
	},
	{
		...
		displayOptions: {
				show: {
						operation: [
							'get-app-store-keywords-for-app',
							'get-app-store-app-competitors'
						],
				},
		},
		default: '',
