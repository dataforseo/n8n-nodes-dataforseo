...
export async function searchApps(ef: IExecuteFunctions, i: number) {
	const params: IHttpRequestOptions = {
		url: '/app_data/apple/app_searches/task_post',
		body: [{
	...
	return dataForSeoPOSTGETRequest(ef, params, '/app_data/apple/app_searches/task_get/advanced/');
}

export async function getAppList(ef: IExecuteFunctions, i: number) {
	const params: IHttpRequestOptions = {
		url: '/app_data/apple/app_list/task_post',
		body: [{
	...
	return dataForSeoPOSTGETRequest(ef, params, '/app_data/apple/app_list/task_get/advanced/');
}

export async function getAppInfo(ef: IExecuteFunctions, i: number) {
	const params: IHttpRequestOptions = {
		url: '/app_data/apple/app_info/task_post',
		body: [{
	...
	return dataForSeoPOSTGETRequest(ef, params, '/app_data/apple/app_info/task_get/advanced/');
}

export async function getAppleAppReviews(ef: IExecuteFunctions, i: number) {
	const params: IHttpRequestOptions = {
		url: '/app_data/apple/app_reviews/task_post',
		body: [{
			app_id: ef.getNodeParameter('app_id', i),
			location_name: ef.getNodeParameter('location_name', i),
			language_name: ef.getNodeParameter('language_name', i),
			priority: ef.getNodeParameter('priority', i) || null,
			depth: ef.getNodeParameter('depth_for_reviews', i) || null,
			sort_by: ef.getNodeParameter('sort_by', i) || null
		}]
	};

	return dataForSeoPOSTGETRequest(ef, params, '/app_data/apple/app_reviews/task_get/advanced/');
}
...
export async function getAppListingSearch(ef: IExecuteFunctions, i: number) {
	...
	const params: IHttpRequestOptions = {
		url: '/app_data/apple/app_listings/search/live',
		body: [{
